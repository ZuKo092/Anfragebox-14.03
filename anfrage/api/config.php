...
define('BRAND_NAME',     env('BRAND_NAME', 'AnfrageBox'));
...
// ── Notify URL (for lead notifications; leave empty to auto-detect from request) ─
define('NOTIFY_INTERNAL_BASE_URL', env('NOTIFY_INTERNAL_BASE_URL'));
